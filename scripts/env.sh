...
#sudo cp -a /media/psf/baseQI/$root_dir-64 /$root_dir
#/$root_dir/
# ├── cf
# │   └── UNF_1_6_10_55.cf
...
sudo cp $root_dir/conf/etc/apache2/ports.conf /etc/apache2/
sudo chmod o-w /etc/apache2/ports.conf
...
yes | sudo gdebi $root_dir/deb-client-server-64/1c-enterprise83-common_8.3.10-2299_amd64.deb
delimiter
yes | sudo gdebi $root_dir/deb-client-server-64/1c-enterprise83-common-nls_8.3.10-2299_amd64.deb
delimiter
yes | sudo gdebi $root_dir/deb-client-server-64/1c-enterprise83-server_8.3.10-2299_amd64.deb
delimiter
yes | sudo gdebi $root_dir/deb-client-server-64/1c-enterprise83-server-nls_8.3.10-2299_amd64.deb
delimiter
yes | sudo gdebi $root_dir/deb-client-server-64/1c-enterprise83-ws_8.3.10-2299_amd64.deb
delimiter
yes | sudo gdebi $root_dir/deb-client-server-64/1c-enterprise83-ws-nls_8.3.10-2299_amd64.deb
...
sudo cp $root_dir/conf/opt/1C/v8.3/x86_64/conf/logcfg.xml /opt/1C/v8.3/x86_64/conf/
...
sudo cp $root_dir/conf/etc/apache2/mods-enabled/wsap24.load /etc/apache2/mods-enabled/
...
yes | sudo gdebi $root_dir/deb-client-server-64/1c-enterprise83-client_8.3.10-2299_amd64.deb
delimiter
yes | sudo gdebi $root_dir/deb-client-server-64/1c-enterprise83-client-nls_8.3.10-2299_amd64.deb
