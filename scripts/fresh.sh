...
sudo cp $root_dir/conf/etc/apache2/1cfresh_a/sm.conf "/etc/apache2/1cfresh_a/$fresh_base_name.conf"
sudo sed -i "s/<--ibname-->/$fresh_base_name/g" "/etc/apache2/1cfresh_a/$fresh_base_name.conf"
sudo chmod o-w /etc/apache2/1cfresh_a

sudo chmod o+w /etc/apache2/1cfresh_int
sudo cp $root_dir/conf/etc/apache2/1cfresh_int/sm.conf "/etc/apache2/1cfresh_int/$fresh_base_name.conf"
...
sudo cp $root_dir/conf/var/www/1cfresh/a/sm/default.vrd "/var/www/1cfresh/a/$fresh_base_name/default.vrd"
...
sudo cp $root_dir/conf/var/www/1cfresh/int/sm/default.vrd "/var/www/1cfresh/int/$fresh_base_name/default.vrd"
...
sudo chmod o+w /etc/apache2/1cfresh_a
sudo cp $root_dir/conf/etc/apache2/1cfresh_a/app.conf "/etc/apache2/1cfresh_a/$solution_base_name.conf"
sudo sed -i "s/<--ibname-->/$solution_base_name/g" "/etc/apache2/1cfresh_a/$solution_base_name.conf"
sudo chmod o-w /etc/apache2/1cfresh_a

sudo chmod o+w /etc/apache2/1cfresh_int
sudo cp $root_dir/conf/etc/apache2/1cfresh_int/app.conf "/etc/apache2/1cfresh_int/$solution_base_name.conf"
...
sudo cp $root_dir/conf/var/www/1cfresh/a/app/default.vrd "/var/www/1cfresh/a/$solution_base_name/default.vrd"
...
sudo cp $root_dir/conf/var/www/1cfresh/int/app/default.vrd "/var/www/1cfresh/int/$solution_base_name/default.vrd"
