...
sudo rm -fr fresh-install-32.zip
sudo rm -fr /fresh-install

sudo curl -O https://transfer.sh/105BYV/fresh-install-32.zip

sudo unzip fresh-install-32.zip
sudo mkdir /fresh-install
sudo cp -a fresh-install-32/* /fresh-install/
sudo rm -fr fresh-install-32
sudo rm fresh-install-32.zip
...
#!/bin/bash
root_dir=/fresh-install
yes | sudo gdebi $root_dir/deb-client-server-32/1c-enterprise83-common_8.3.10-2667_i386.deb
yes | sudo gdebi $root_dir/deb-client-server-32/1c-enterprise83-common-nls_8.3.10-2667_i386.deb
yes | sudo gdebi $root_dir/deb-client-server-32/1c-enterprise83-server_8.3.10-2667_i386.deb
yes | sudo gdebi $root_dir/deb-client-server-32/1c-enterprise83-server-nls_8.3.10-2667_i386.deb
yes | sudo gdebi $root_dir/deb-client-server-32/1c-enterprise83-ws_8.3.10-2667_i386.deb
yes | sudo gdebi $root_dir/deb-client-server-32/1c-enterprise83-ws-nls_8.3.10-2667_i386.deb
...
sudo chmod o+w /opt/1C/v8.3/i386/conf
...
</config>' >> /opt/1C/v8.3/i386/conf/logcfg.xml
sudo chmod o-w /opt/1C/v8.3/i386/conf/logcfg.xml
...
echo "LoadModule _1cws_module /opt/1C/v8.3/i386/wsap24.so" >> /etc/apache2/mods-enabled/wsap24.load
...
yes | sudo gdebi $root_dir/deb-client-server-32/1c-enterprise83-client_8.3.10-2667_i386.deb
yes | sudo gdebi $root_dir/deb-client-server-32/1c-enterprise83-client-nls_8.3.10-2667_i386.deb

base_name=mymoney
mras='/opt/1C/v8.3/i386/ras'
mrac='/opt/1C/v8.3/i386/rac'
...
/opt/1C/v8.3/i386/./webinst -apache24 -wsdir mymoney -dir /var/www/pub/mymoney -connstr "File=/pub/money;" -confPath /etc/apache2/1cpub/app.conf


export JAVA_HOME=/usr/lib/jvm/java-8-oracle/
/opt/1C/1CE/i386/ring/ring license activate --first-name "Ildar" --last-name "Gabdrakhmanov" --email "ildarcheg@gmail.com" --country "RU" --zip-code "000" --region "Moscow" --town "Moscow" --street "Lenina" --house 10 --serial "20009305688" --pin "9793-5524-1177-3203" --validate


root@mymoney:~# /opt/1C/1CE/i386/ring/ring license activate --first-name "Ildar" --last-name "Gabdrakhmanov" --email "ildarcheg@gmail.com" --country "RU" --zip-code "000" --region "Moscow" --town "Moscow" --street "Lenina" --house 10 --serial "20009305688" --pin "9793-5524-1177-3203" --validate
...
sudo /opt/1C/v8.3/i386/./webinst -apache24 -wsdir mym -dir /var/www/pub/money -connstr "File=/pub/money;" -confPath /etc/apache2/1cpub/app.conf
echo 'Include 1cpub/*.conf' >> /etc/apache2/ports.conf
sudo service apache2 restart


adduser ildar
usermod -aG sudo ildar
su - ildar
sudo ls -la /root
